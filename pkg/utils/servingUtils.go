...
func GetServiceSpec(imageName string, fn runtimev1alpha1.Function, riUtil *RuntimeInfo) servingv1alpha1.ServiceSpec {
	defaultMode := int32(420)
	buildContainer := getBuildContainer(imageName, fn, riUtil)
			...
			VolumeSource: corev1.VolumeSource{
				ConfigMap: &corev1.ConfigMapVolumeSource{
					...
					LocalObjectReference: corev1.LocalObjectReference{
						Name: riUtil.GetDockerFileName(fn.Spec.Runtime),
					},
				},
			},
		},
			...
			Configuration: servingv1alpha1.ConfigurationSpec{
				Build: &servingv1alpha1.RawExtension{
					BuildSpec: &buildv1alpha1.BuildSpec{
						ServiceAccountName: riUtil.ServiceAccount, // TODO: make it configurable
